...
export default function Contact() {
  ...
  return (
    <section id="contact" className="bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 py-24 relative overflow-hidden">
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400">ann@satyamregmi.com.np</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center mr-4">
                  ...
                  <div>
                    <h5 className="text-lg font-medium text-gray-900 dark:text-white">Phone</h5>
                    <p className="text-gray-600 dark:text-gray-400">+977 9840112337</p>
                  </div>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center mr-4">
                  ...
                  <div>
                    <h5 className="text-lg font-medium text-gray-900 dark:text-white">Location</h5>
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <motion.a 
                  ...
                  className="w-12 h-12 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-600 dark:text-gray-400 hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-blue-900/50 dark:hover:text-blue-400 transition-colors"
