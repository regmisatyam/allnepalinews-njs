...
const NavBar = () => {
    ...
    return (
        <nav className="flex justify-between items-center p-6 bg-custom-blue relative">
            ...
            <div
                id="menu"
                className={`fixed md:relative top-0 right-0 z-10 h-full md:h-auto w-64 md:w-auto bg-blue-800 md:bg-transparent text-center md:text-left transform ${menuOpen ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 ease-in-out md:transform-none md:transition-none`}
            >
