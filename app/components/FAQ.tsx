...
export default function FAQ() {
    const faqs = [
        ...
        {
            question: 'How to contact ANN for bugs / feedbacks ?',
            answer: 'You can contact ANN by: Email: ann@satyamregmi.com.np, Website: https://satyamregmi.com.np/contact'
        },
        {
            question: 'What data does ANN collect?',
            answer: `ANN only collects the data required for app to properly function. Such as: "Device Advertising Id": For showing relevant ads. "Data of News Link Opened": Starting from app version 2.0.0 We only record news-link and device to calculate which news is clicked at most. Unless you open any news we wont collect any link history.`
        },
        {
            question: 'How to delete my data?',
            answer: `To delete your data(link history) you can visit at: https://satyamregmi.com.np/AllNepaliNews/user-data/delete-my-data/ with your device id. You can find your device id: 1) Open 'All Nepali News' app 2) Click on Settings Icon`
        },
        {
            question: 'Is ANN news media company?',
            answer: `No ANN is not news media company. ANN is an application that fetch news from different trusted news-medias without interfering traffic/views on original media. We provide credit and news link incase user want to read full news.`
        }
    ]
