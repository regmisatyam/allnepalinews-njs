...
const Privacy = () => {
    return (
        <div className='pt-20 container mx-auto px-4'>
            ...
            <p className='text-sm text-gray-500'>Effective from September 23, 2023</p>
            ...
            <div className='mt-4'>
                ...
                <br />   
                <br />    <b>1.1. The information you provide us</b>
                <br />    When you send us a message using an online form or contact us by email or phone, or subscribe to our mailing list, we may collect your email address, phone number, name, and other personal information that you provide us. We also collect any information that you voluntarily provide to help us resolve any issues within our service.
                <br />    
                <br />    Account Information
                <br />    When you create an account, we collect the personal information you provide, like your full name, email address, phone number, birthday, and photo.
                <br />   
                <br />    Information you upload
                <br />    We collect information about other people, like photos, videos, phone numbers, email addresses, that you may upload to our services. For example, you may upload your contacts to see which of your friends are already playing a game, or invite them to try a new app. Or, you may upload a photo to our service for editing or sharing with other users.
                <br />    
                <br />    The content you create & share
                <br />    When you use our service, we collect the content that you create, upload, share, and the content that others have shared with you. Content means all kinds of text, files, and digital information that you upload, documents you create, the messages you send, posts you write, comments you make, and opinions you share using our service.
                <br />    
                <br />    <b>1.2. The information we automatically collect</b>
                <br />    When you use our services, we collect information about the browser or apps you used to access our services, information about your device, network, operating system, and crash reports. We may also collect unique identifiers about your device or browser using cookies or other technologies.
                <br />    
                ...
                <br />    
                <br />    Information from installed apps
                ...
                <br />    
                <br />    <b>1.3. Information from other sources</b>
                <br />    We may also collect information about you from public sources, and when service providers, marketing partners, security researchers, or other users of our services provide us with that information. For example, another user of our service may upload their contact list, which includes your information.
                <br />    
                <br />    We collect such information to prevent abuse of our services, improve our services, identify business opportunities, and provide services to our users. We may combine information collected from such sources with the information that we have collected from you.
                <br />    <br />
                <br />    <b>2. How we use your information</b>
                <br />    We use the information we collect from our services to provide you with the necessary services and improve, protect, and maintain our services. We also use the information to develop new features in our services and to protect your private information.
                <br />    <br />
                <br />    <b>2.1. To prevent fraud</b>
                <br />    We may use the information collected from you from various sources to prevent fraud and illegal use of our service. We may use the information to verify your identity or revoke your access to the service if you make any unauthorized use of our service.
                <br />    <br />
                ...
                <br />    <br />
                <br />    <b>3.1. With our users</b>
                <br />    We share your name and photo to other users of our services. For example, when someone searches for your name on our services, we may show your information. We may also display your name, username, and photo to other users when they play a multi-player game with you. We may also share information about how you used our services, and any information we derive from it, such as the last time you used our service, your online status, the number of games you played, and the scores you obtained.
                <br />    <br />
                <br />    <b>3.2. With the general public</b>
                <br />    We may display your public information across our services name and photo to other players looking for other people to play together. Or we may post your name and picture on our website when you leave a comment or write a review of our services. We may also display your contact information in our services with your permission.
                <br />    <br />
                <br />    <b>3.3. With our business partners</b>
                <br />    Suppose we are involved in a merger, acquisition, or asset sale. In that case, we will give you a notice in advance before your information is transferred or becomes subject to a different privacy policy. If we do not have any medium to send out a notification to you, we will destroy such information before the event of a merger, acquisition, or asset sale.
                <br />    <br />
                <br />    <b>3.4. With our service providers</b>
                <br />    We share your information to help our service providers, affiliates, and trusted agents store and process it on our behalf. For example, we need to provide your name, address, and contact information to our payment service providers; or we may need to provide information about you to our hosting providers to store it for us. We will have a contract in place that prevents unauthorized access to such information.
                <br />    <br />
                <br />    <b>3.5. With our affiliates and partners</b>
                <br />    We share non-personal information like analytics data, crash reports, file metadata, server logs, and usage information with our service providers, partners, advertisers, and other companies or individuals that work with us. They may use the information that we shared according to their privacy policy.
                <br />    <br />
                <br />    <b>3.6. With the third-party</b>
                <br />    We share your information with third-party services when we get your opt-in consent to share with them on your behalf. When you log in to third-party services using your account in our service, we may share your account information like your name, username, date of birth, email address, and phone number with your permission.
                <br />    <br />
                <br />    We also share information about you for security and legal purposes. If we have good faith of belief that sharing your information is required to:
                <br />    <br />
                ...
                <br />    We always try to protect our infrastructure from unauthorized access to the data we store. We encrypt the network connection to or from our service to prevent unauthorized access to the information in transit. We have systems in place to help you protect your account and personal information.
                <br />    <br />
                <br />    We review the server logs for potential security risks and use monitoring tools to monitor our servers regularly. We regularly scan our servers for outdated software and known security issues. Our employees, contractors, and agents access personal information only after signing a legally-binding confidentiality agreement, and when it is necessary to do so.
                <br />    <br />
                <br />    5. How long we keep your information
                <br />    How long we keep information depends on the type of information and how long you want us to keep it.
                <br />    √ We keep your account information like your name, email address, and phone number until you request us to delete it, or if you stop using our services for more than 2 years, we will delete your data in our possession due to inactivity. To submit a request for deletion of your data, please use our Information Request Form .
                <br />    √ We may keep your account and usage information for a more extended period if required by the law. When we receive a legal request to preserve such information, or we need to keep such information to support an ongoing investigation about the misuse of our services.
                <br />    √ If you have communicated with us through email, chat, feedback form, or other mediums, we may retain the information you shared as long as the law permits.
                <br />    √ We keep the content you create and share using our services until the purpose of sharing such information is fulfilled. For example, if you upload a picture for editing, we will remove it after returning you the edited image.
                <br />    √ We may keep a copy of the content you created or shared using our service to continue providing our service to other users as long as their account is active. For example, if you shared a photo or message with other users, even if you delete the message from your inbox, a copy of the message and file will be kept so that the other person can see it.
                <br />    √ We keep our server logs, analytics data, and usage information for a more extended period and automatically delete information older than a year.
                <br />    √ We keep essential records such as your information about your purchases, invoices, etc. to maintain a financial record as long as the law permits us. We may use such information to prevent abuse of our services, identify illegal activities, and resolve disputes that may arise in the future.
                <br />    √ When you ask us to delete your information, we immediately remove such information from the public view. Our systems will start deleting information from our databases and storage systems. It may take some time, depending on the service load and the type of information you requested to delete. We may have retained some of the information in our backup storage, which our scheduled backup deletion mechanism will delete.
                <br />    <br />
                <br />    In some rare cases caused by a system failure, outage, bugs, or human error, the information you requested us to delete might not be entirely removed or might be restored from backup. In case you discover such an incident, you can ask us to ensure your information is properly deleted from all our services.
                <br />    <br />
                <br />    6. Your control over your information
                <br />    We want you to be in full control of your information, so we provide you with the following options.
                <br />    <br />
                <br />    6.1. Review, edit, and take-out your information.
                <br />    In supported services, you can review and make changes to your account from the Account Settings page; you can also export a copy of your information from the take-out page. You can also contact us to request a change or obtain a copy of your information.
                <br />    <br />
                <br />    6.2. Deny and revoke permissions
                ...
                <br /><br />
                Our products and services use the following third-party products and services, and your use of our Product that integrates these services is subject to their privacy policy. We have linked their privacy policies so that you can review what information they collect and how they use it.
                <br /><br />
                Service Providers:
                <br />            <b>Google Play Services</b>
                <br />             <b>Google Analytics for Firebase</b>
                <br />        <b>Firebase Crashlytics</b>
                <br /><br />
                ...
                All Nepali News <br />
                Kathmandu, Nepal <br />
                Email: ann@satyamregmi.com.np <br />
                Website: https://www.allnepalinews.com <br />
                <br /><br />
            </div>
        </div>
    )
